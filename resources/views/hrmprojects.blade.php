          ...
          <div class="row justify-content-center">
            <div class="col-12">
              <div class="row align-items-center mb-4">
                ...
                <div class="col-auto">
                  <button type="button" class="btn mb-2 bg-gold  text-white" data-toggle="modal" data-target="#varyModal" data-whatever="@mdo"><i class="fe fe-plus mx-1"></i>Add new </button>
