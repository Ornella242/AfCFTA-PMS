...
<div class="card">
  ...
  <div class="card-body">
    <div class="info">
      ...
      <span class="value">{{ $requester->firstname }} {{ $requester->lastname }}</span>
    </div>
    <div class="info">
    ...
    <div class="info">
      ...
      <div class="value" style="margin-left: 0; margin-top: 6px;">{{ $reason }}</div>
    </div>

    <a href="{{ url('/allprojects') }}" class="button">
