                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <ul class="nav nav-tabs custom-nav" id="taskTabs" role="tablist">
                            @if (auth()->user()->role && auth()->user()->role->name === 'Admin') 
                                <li class="nav-item">
                                    <a class="nav-link" id="summary-tab" data-toggle="tab" href="#summary-tab-content" role="tab" aria-controls="summary-tab-content" aria-selected="true">
                       ...
                       <!-- Filtre Units -->
                        <form method="GET" action="{{ route('tasks.indexadmin') }}" class="ml-auto d-flex align-items-center">
                            <label for="unit_id" class="mb-0 mr-2 text-muted small">
                                <i class="fe fe-filter text-maroon"></i>
                            </label>
                            <select name="unit_id" id="unit_id" 
                                    class="form-control form-control-sm rounded-pill shadow-sm border-2" 
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content shadow-lg rounded-lg">
                ...
                <div class="modal-body p-4">
                    ...
                    <!-- Zone Formulaire Édition (hidden au début) -->
                    <form id="taskEditForm" action="" method="POST" style="display:none;">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="start_date" id="editTaskStart">
                        </div>

                        <div class="form-group">
                            <label>End Date</label>
                            <input type="date" class="form-control" name="end_date" id="editTaskEnd">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="assigned_user_id" id="editTaskUser">
                                @foreach($users as $user)
                                    <option value="{{ $user->id }}">{{ $user->firstname }} {{ $user->lastname }}</option>
                                @endforeach
                            </select>
                ...
                <div class="modal-footer">
                    <button id="editTaskBtn" class="btn btn-warning"><i class="fe fe-edit"></i> Edit</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    taskCard.addEventListener('click', function() {
        ...
        // Tu peux aussi remplir les détails du modal ici
