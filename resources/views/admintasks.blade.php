...
<main role="main" class="main-content">
        <div class="container-fluid">
          <div class="row justify-content-center">
            <div class="col-12">
              <h2 class="page-title text-center text-green">Admin Tasks</h2>
              <div class="row">
                  ...
                  <div class="card shadow">
                    <div class="card-body">
                       ...
                       <div class="row my-4 d-none d-lg-flex align-items-center justify-content-between">
                            ...
                            <div>
                                <button type="button" class="btn mb-2 bg-gold text-white ml-3" data-toggle="modal" data-target="#createtask" data-whatever="@mdo">
                                Create Task
                                </button>
