...
<main role="main" class="main-content">
        <div class="container-fluid">
          <div class="row justify-content-center">
            <div class="col-12">
              <h2 class="page-title text-center">All Tasks</h2>
              <div class="row">
                  ...
                  <div class="card shadow">
                    <div class="card-body">
                      <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
                        <li class="nav-item">
                          <a class="nav-link active" id="admintask-tab" data-toggle="tab" href="#admin" role="tab" aria-controls="admintask" aria-selected="true">Admin Tasks</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" id="hrmtask-tab" data-toggle="tab" href="#hrm" role="tab" aria-controls="hrmtask" aria-selected="false">HRM Tasks</a>
                        </li>
                        
                      </ul>
                        <div class="row  my-4  d-none d-lg-flex">
                            <div class="ml-3">
                                <button type="button" class="btn mb-2 bg-yellow text-white" data-toggle="modal" data-target="#createtask" data-whatever="@mdo">Create Task</button>
                      ...
                      <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="hrm" role="tabpanel" aria-labelledby="hrmtask-tab">
                            <div class="card-body p-0">
                                <table class="table mb-0 table-hover">
                                <thead class="thead-light">
                                    <tr>
